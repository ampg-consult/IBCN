...
import com.ampgconsult.ibcn.data.ai.*
...
object RepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideAutonomousAgentEngine(
        aiService: AIService,
        ...
        auth: FirebaseAuth,
        firestore: FirebaseFirestore
    ): AutonomousAgentEngine = AutonomousAgentEngine(
        aiService, fileService, projectRepository, projectContextService, auth, firestore
    )
}
